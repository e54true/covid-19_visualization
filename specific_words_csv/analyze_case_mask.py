...
# Reading CSV files
df1 = pd.read_csv('twitter_mask_results.csv')
...
ax1.set_ylabel('Mask Count', color='tab:blue')
ax1.plot(merged_df['Month'], merged_df['Mask Count'], color='tab:blue')
...
plt.title('Trend Comparison with mask and case')
plt.show()

# Calculating correlation coefficient (optional)
correlation = merged_df['Mask Count'].corr(merged_df['counts'])
